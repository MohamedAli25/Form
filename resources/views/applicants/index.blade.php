...
<body>
    ...
    <div class="container-fluid">
        ...
        for($i = 0; $i < 6; $i++) {
            ...
            $counter_day = 1;
            for($j = 0; $j < 10; $j++) {
                $time_slots_period = $time_slots[$i * 10 + $j];
                
                foreach ($time_slots_period->applicants as $applicant) {
                    echo "<tr>
                    <th scope='col'>" . $counter_day . "</th>
                    <th scope='col'><a href=/277640/applicants/" . $applicant->id . "/edit>" . $applicant->first_name . ' ' . $applicant->last_name ."</a></th>
                    <th scope='col'>" . $applicant->email . "</th>
                    <th scope='col'>" . $applicant->phone_number . "</th>
                    <th scope='col'>" . $applicant->university . "</th>
                    <th scope='col'>" . $applicant->faculty . "</th>
                    <th scope='col'>" . $applicant->department . "</th>
                    <th scope='col'>" . $applicant->academic_year . "</th>
